...
def _provision_roles() -> None:
    ...
    statements = [
        ...
        "CREATE TABLE IF NOT EXISTS public.qpg_harness_keys(id BIGINT PRIMARY KEY, created_at TIMESTAMPTZ NOT NULL)",
        "TRUNCATE public.qpg_harness_orders RESTART IDENTITY",
        "TRUNCATE public.qpg_harness_keys",
        "INSERT INTO public.qpg_harness_orders(status) VALUES ('database timeout while scraping')",
        "INSERT INTO public.qpg_harness_keys(id, created_at) VALUES (1, now()), (2, now()), (3, now())",
        "REVOKE ALL ON TABLE public.qpg_harness_orders FROM qpg_ro_user, qpg_rw_user, qpg_rw_group",
        "REVOKE ALL ON TABLE public.qpg_harness_keys FROM qpg_ro_user, qpg_rw_user, qpg_rw_group",
        "GRANT SELECT ON TABLE public.qpg_harness_orders TO qpg_ro_user, qpg_rw_user",
        "GRANT SELECT ON TABLE public.qpg_harness_keys TO qpg_ro_user, qpg_rw_user",
